...
public class GroceryBillingSystemApp {

    private static final Logger log = LoggerFactory.getLogger(GroceryBillingSystemApp.class);

    private final Environment env;

    public GroceryBillingSystemApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes groceryBillingSystem.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GroceryBillingSystemApp.class);
